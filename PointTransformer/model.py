...
class Backbone(nn.Module):
    def __init__(self,npoints, nblocks, nneighbor,n_c,d_points=3,transformer_dim=512,num_class=10,input_dim=4):
        super().__init__()
        ...
        # npoints, nblocks, nneighbor, n_c, d_points = 1024, nblocks, nneighbor, num_class, input_dim
        self.fc1 = nn.Sequential(
